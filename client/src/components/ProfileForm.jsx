  ...
  return (
    <form onSubmit={handleSubmit} className='card p-5 sm:p-6 mb-6'>
        ...
        <div>
                            ...
                            <textarea disabled={initialData.isDeleted} defaultValue={initialData.bio || ""} name="bio" rows={3} className={`resize-none ${initialData.isDeleted ? "bg-slate-50 text-slate-400 cursor-not-allowed" : ""}`} placeholder='Write a brief bio...' />
