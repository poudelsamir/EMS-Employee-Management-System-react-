  ...
  const sidebarContent = (
    <>
      ...
      <div className="px-5 pt-6 pb-6 border-b border-white/6">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="cursor-pointer lg:hidden text-slate-400 hover:text-white p-1"
          >
            <XIcon size={20} />
          </button>
        </div>
      ...
      <div className="p-3 border-t border-white/6">
        <button onClick={handleLogout} className="cursor-pointer flex items-center gap-3 w-full px-3 py-2.5 rounded-md text-[13px] font-medium text-slate-400 hover:text-rose-400 hover:bg-rose-500/8 transition-all duration-150" >
  ...
  return (
    <>
      ...
      <button
        ...
        className="cursor-pointer lg:hidden fixed top-4 left-4 z-50 p-2 bg-slate-900 text-white rounded-lg shadow-lg border border-white/10"
      >
        <MenuIcon size={20} />
      </button>
