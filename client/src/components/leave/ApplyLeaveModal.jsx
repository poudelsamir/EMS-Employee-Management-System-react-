    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
            {/* Leave type */}
            <div>
                <label className="flex items-center font-medium text-slate-700 mb-2 gap-2 text-sm">
            ...
            <div className="flex gap-3 pt-2">
                ...
                <button onClick={onClose} disabled={loading} type="submit" className="btn-primary flex items-center justify-center gap-2 flex-1">
