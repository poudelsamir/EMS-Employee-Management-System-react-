        ...
        <div className="w-full max-w-md animate-fade-in relative z-10">
          ...
          <div className="space-y-4">
            {portalOptions.map((portal)=>(
              <Link key={portal.to} to={portal.to} className="group block bg-slate-50 border border-slate-200 rounded-lg p-5 sm:p-6 transition-all duration-00 hover:border-indigo-400 hover:bg-indigo-50">
